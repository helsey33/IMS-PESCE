...
class CreateProfile extends React.Component {
  ...
  onSubmit(e) {
    ...
    this.props.addGradDetails(gradDetails, this.props.history);
  }
          ...
          <GridItem xs={12} sm={12} md={12}>
            <Card>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>Graduation</h4>
...
export default withStyles(styles)(
  connect(
    mapStateToProps,
    { addGradDetails, getCurrentProfile }
